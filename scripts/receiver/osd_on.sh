...
MY_OSD_STR=${OSD_STR:-' '}
MY_OSD_FONT_SIZE=${OSD_FONT_SIZE:-'30'}
MY_OSD_FONT_COLOR=${OSD_FONT_COLOR:-'0xFF00FF00'}
MY_OSD_TRANSPARENT=${OSD_TRANSPARENT:-'31'}
MY_OSD_MAX_Y_SIZE=${OSD_MAX_Y_SIZE:-'200'}
...
ast_send_event -1 "e_osd_on_str::0::$MY_OSD_MAX_Y_SIZE::$MY_OSD_TRANSPARENT::1::$MY_OSD_OFF_TIMER::$MY_OSD_STR::$MY_OSD_FONT_SIZE::$MY_OSD_FONT_COLOR"
...
legacy_code()
{
	...
	echo "1 $MY_OSD_TRANSPARENT 1 0 $MY_OSD_MAX_Y_SIZE" > "$DISPLAY_SYS_PATH"/osd_from_gui
}
### End of Legacy code #######################################################
